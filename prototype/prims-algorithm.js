...
var vertexNum, distanceMatrix, loop, loop2, loop3, startPoint, endPoint, distanceMatrixX, distanceMatrixY, edgeLength, inspectColumns = [], tempArray = [], tempSmallestNumber, temp1, temp2, alreadyDone1 = false, alreadyDone2 = false, alreadyDone3 = false, firstEdgeText = "", secondEdgeText = "", thirdEdgeText = "", totalEdgeLength = 0;
...
function init() {
  if (isNaN(parseInt(document.getElementById("vertexNum").value))) {
    ...
    alert("Sorry, as of 28/08/15, this application can only deal with graphs of 4 vertices.  Please remember to check regularly!");
  } else {
...
function drawMatrix() {
  if (vertexNum === 4) {
    ...
    console.log("This program can currently only deal with graphs of 4 vertices.  Sorry for the inconvenience.");
  }
}
